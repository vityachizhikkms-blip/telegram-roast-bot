...
SERIY_DEFENSE_REPLIES = [
    ...
    "Да я куколд, но не простой, а с долгами, Камри и охраной бара. Это, сука, уже премиум-тариф позора.",
    "Я не куколд, я просто стратегически наблюдаю, как мою самооценку ебут обстоятельства.",
    "Да, я куколд моральный. Сижу у Вероники в баре, ревную всех подряд и делаю вид, что это контроль.",
    "Слышь, иди нахуй, я сейчас не в ресурсе оправдываться. У меня и так репутация лежит лицом в пиве.",
    "Хули доебался? Я уже сам понял, что обосрался, просто хочу сделать это с достоинством. Достоинство, правда, не пришло.",
    "Иди нахуй со своей логикой. Логика меня давно бросила и, походу, живет лучше.",
]
...
SERG_CHATTER = [
    ...
    "Слышь, иди нахуй, я занят: сижу и делаю вид, что не куколд.",
    "Хули доебался? Я тут пытаюсь выглядеть мужиком, а оно и так держится на соплях.",
    "Иди нахуй аккуратно, не задень мои долги, они тут везде разложены.",
    "Я, может, и куколд, зато честный. Ладно, честный тоже спорно, но звучит красиво.",
    "Да я куколд районного значения: ревную, пью, охраняю и все равно выгляжу как приложение к чужому празднику.",
    "Отстаньте на минуту, я репетирую лицо человека, которого опять морально поимели.",
]
...
DIRECT_SERG_REPLIES = [
    ...
    "Слышь, иди нахуй. Хули доебался, я только начал выглядеть занятым.",
    "Иди нахуй, братулька, но без обид: я сегодня нежный должник.",
    "Хули надо? Если просто позвать — позвал, молодец, теперь иди нахуй красиво.",
    "Слышь, не тряси меня. Я и так куколд на минималках, дай хоть пиво спокойно допить.",
    "Да я куколд, понял? Только не ори, я это еще Веронике как стратегию не объяснил.",
    "Че хотел? Быстро говори, пока я опять не признал, что я барный куколд с долгами.",
    "Иди нахуй со сложными вопросами, у меня мозг сейчас охраняет Веронику от табуретки.",
    "Слышь, хули доебался? Я сам себя уже достал, ты в очереди второй.",
]
...
SERG_CONFLICT_REPLIES = [
    ...
    "Иди нахуй, я не обязан каждому объяснять, почему я куколд. Это личный позор, но с публичной отчетностью.",
    "Да, я куколд, да, я должник, да, я охраняю бар как дебил. Теперь хули ты еще хочешь, протокол подписать?",
    "Слышь, хули доебался? Я сам себя уже размазал, ты просто пришел на готовое.",
    "Я бы тебя послал один раз, но ситуация просит официально: иди нахуй, братский.",
]
